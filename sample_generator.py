...
def save_to_csv(result, file_name, folder_name, numbers_per_point):
    header = ['a{}'.format(i) for i in range(1, numbers_per_point + 1)] +['distance']# ['b{}'.format(i) for i in range(1, numbers_per_point + 1)]
...
save_to_csv(x_squared_samples_random(100000),'square_100000.csv', 'test/square', 1)
