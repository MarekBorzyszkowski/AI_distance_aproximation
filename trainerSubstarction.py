...
model2 = keras.models.load_model('models/subtraction/1_model')

df = pd.read_csv('csv/training/subtract/minus_10000.csv')
X = df[labels]
...
ckp_cbk = tf.keras.callbacks.ModelCheckpoint('models/subtraction/1_model', save_best_only=True, monitor='loss')
tb_cbk = tf.keras.callbacks.TensorBoard(log_dir='models/subtraction/1_model/logs')
...
# model2.save('models/subtraction/subtract_model.h5')
